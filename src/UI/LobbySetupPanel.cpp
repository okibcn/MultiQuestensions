...
namespace MultiQuestensions::UI
{
	...
	void LobbySetupPanel::AddSetupPanel(UnityEngine::RectTransform *parent, GlobalNamespace::MultiplayerSessionManager *sessionManager)
	{
		...
		vertical2->get_gameObject()->AddComponent<ContentSizeFitter *>()->set_horizontalFit(UnityEngine::UI::ContentSizeFitter::FitMode::MinSize);
		vertical2->get_gameObject()->AddComponent<LayoutElement *>()->set_minWidth(45);

		auto vertical3 = QuestUI::BeatSaberUI::CreateVerticalLayoutGroup(horizontal->get_transform());
		vertical3->get_gameObject()->AddComponent<ContentSizeFitter *>()->set_horizontalFit(UnityEngine::UI::ContentSizeFitter::FitMode::MinSize);
		...
		vertical4->get_gameObject()->AddComponent<ContentSizeFitter *>()->set_horizontalFit(UnityEngine::UI::ContentSizeFitter::FitMode::MinSize);
		vertical4->get_gameObject()->AddComponent<LayoutElement *>()->set_minWidth(45);
		...
		auto colorPicker = QuestUI::BeatSaberUI::CreateColorPickerModal(
			parent, "Player Color Selection", playerColor,
